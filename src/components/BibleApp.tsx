      ...
      <main className="flex-1 w-full max-w-[1600px] mx-auto">
        <header className="sticky top-0 z-10 glass px-8 py-4 mb-8 flex items-center justify-between">
          <div className="flex flex-col">
             <h1 className="text-2xl font-bold text-slate-900 tracking-tight">{t.main.discover}</h1>
             <p className="text-sm text-slate-500">{t.main.subtitle}</p>
          </div>
        ...
        <div className="px-8 pb-12">
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center py-10">
               <h2 className="text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">{t.main.whatWouldYouLikeToExplore}</h2>
